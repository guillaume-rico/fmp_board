...
d3.hexbin = function() {
  ...
  function hexbin(points) {
    ...
    points.forEach(function(point, i) {
      ...
      //    py1 = py - pj;
      var py = y.call(hexbin, point, i) / dy - (pj & 1 ? .5 : 0), pj = Math.round(py),
          px = x.call(hexbin, point, i) / dx, pi = Math.round(px),
          py1 = py - pj;
  ...
  hexbin.centers = function() {
    ...
    //for (var y = odd ? dx / 2 : 0, j = 0; y < height + dy / 2; y += dy, ++j) {
